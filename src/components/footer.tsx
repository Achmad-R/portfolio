  ...
  return (
    <footer className="border-t border-block-fg-inverse/15 bg-block-navy text-block-fg-inverse">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-8 sm:py-10 lg:py-12">
        ...
        <div className="mt-8 grid gap-x-8 gap-y-6 sm:grid-cols-2 lg:mt-12 lg:grid-cols-[1.4fr_repeat(3,minmax(0,1fr))]">
        ...
        <div className="mt-8 flex flex-col gap-4 border-t border-block-fg-inverse/15 pt-5 text-xs sm:flex-row sm:items-center sm:justify-between">
          <p>
